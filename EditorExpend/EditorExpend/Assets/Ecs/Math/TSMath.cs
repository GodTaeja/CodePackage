...
namespace TrueSync
{
    ...
    public sealed class TSMath
    {
        ...
        **/
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
#endif
        public static FP Clamp(FP value, int min, int max)
        {
            return Clamp(value, (FP)(min), (FP)(max));
        }

#if INLINE_ENABLE
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
#endif
        public static FP Clamp(FP value, float min, float max)
        {
            return Clamp(value, (FP)(min), (FP)(max));
        }
        ...
        public static FP Pow2(FP x)
        {
            ...
            x = FP.FromRaw(x.RawValue & FP.FRACTIONAL_PART);
