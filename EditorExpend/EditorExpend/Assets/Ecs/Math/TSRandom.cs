...
namespace TrueSync
{
    ...
    public class TSRandom
    {
        ...
        /**
         *  @brief Returns a random {@link TSVector3} representing a point inside a sphere with radius 1.
         **/
        public static TSVector3 insideUnitSphere
        {
            get
            {
                return new TSVector3(value, value, value);
            }
        }
