                ...
                if (!i.IsStatic && ((type.IsValueType && !type.IsPrimitive) || hasByRef))//need to write back value type instance
                {
                    ...
                    if (type.IsValueType && !type.IsPrimitive)
                    {
                        ...
                        else
                        {
                            ...
                            //if (false)
                            {
                                if (!typeClsName.StartsWith("System.Collections.Generic.KeyValuePair") &&
                                    !typeClsName.EndsWith(".Enumerator"))
                                {
                                    sb.AppendLine(
                                ...
                                {
                                    var name = i.Name;
                                    if (!name.Equals("get_Current") && !name.Equals("get_Key") &&
                                        !name.Equals("get_Value"))
                                    {
                                        sb.AppendLine(
                                            "            WriteBackInstance(__domain, ptr_of_this_method, __mStack, ref instance_of_this_method);");
                                    }
