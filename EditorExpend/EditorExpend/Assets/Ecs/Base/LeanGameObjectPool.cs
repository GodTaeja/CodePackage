...
namespace Lean.Pool
{
	...
	public class LeanGameObjectPool : MonoBehaviour
	{
	    ...
	    public void Release(GameObject cloneGameObject)
	    {
			if (cloneGameObject != null)
			{
                ...
                for (var i = despawnedClones.Count - 1; i >= 0; i--)
                {
                    ...
                    if (clone.GameObject == cloneGameObject)
                    {
                        ...
                        // Remove clone from despawned list
	    ...
	    public void ReleaseAll()
	    {
	        ...
	        {
	            Object.Destroy(spawnedClone.GameObject);
	        }

	        foreach (var despawnedClone in despawnedClones)
	        {
	            Object.Destroy(despawnedClone.GameObject);
	        }
	    }
