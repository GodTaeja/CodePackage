...
namespace TrueSync
{
    ...
    public struct TSMatrix4x4
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
#endif
        public static TSMatrix4x4 Multiply(TSMatrix4x4 matrix1, int scaleFactor)
        {
            TSMatrix4x4 result;
            TSMatrix4x4.Multiply(ref matrix1, scaleFactor, out result);
            return result;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
#endif
        public static void Multiply(ref TSMatrix4x4 matrix1, int scaleFactor, out TSMatrix4x4 result)
        {
            FP num = scaleFactor;
            result.M11 = matrix1.M11 * num;
            result.M12 = matrix1.M12 * num;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
#endif
        public TSVector3 MultiplyVector(TSVector3 vector)
        {
            TSVector3 vector1;
            vector1.x = vector.x * M11 + vector.y * M12 + vector.z * M13;
            vector1.y = vector.x * M21 + vector.y * M22 + vector.z * M23;
            vector1.z = vector.x * M31 + vector.y * M32 + vector.z * M33;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
#endif
        public TSVector3 MultiplyPoint(TSVector3 point)
        {
            TSVector3 vector;
            vector.x = point.x * M11 + point.y * M12 + point.z * M13 + M14;
            vector.y = point.x * M21 + point.y * M22 + point.z * M23 + M24;
            vector.z = point.x * M31 + point.y * M32 + point.z * M33 + M34;

            FP w = point.x * M41 + point.y * M42 + point.z * M43 + M44;
            w = FP.One / w;
            vector.x *= w;
            vector.y *= w;
            vector.z *= w;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
#endif
        public TSVector3 MultiplyPoint3x4(TSVector3 position)
        {
            TSVector3 vector;
            vector.x = position.x * M11 + position.y * M12 + position.z * M13 + M14;
            vector.y = position.x * M21 + position.y * M22 + position.z * M23 + M24;
            vector.z = position.x * M31 + position.y * M32 + position.z * M33 + M34;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
#endif
        public static TSMatrix4x4 Translate(TSVector3 translation)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
#endif
        public static TSMatrix4x4 Scale(FP xScale, FP yScale, FP zScale, TSVector3 centerPoint)
        {
            TSMatrix4x4 result;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
#endif
        public static TSMatrix4x4 Scale(TSVector3 scales)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
#endif
        public static TSMatrix4x4 Scale(TSVector3 scales, TSVector3 centerPoint)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
#endif
        public static TSMatrix4x4 Scale(FP scale, TSVector3 centerPoint)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
#endif
        public static TSMatrix4x4 RotateX(FP radians, TSVector3 centerPoint)
        {
            TSMatrix4x4 result;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
#endif
        public static TSMatrix4x4 RotateY(FP radians, TSVector3 centerPoint)
        {
            TSMatrix4x4 result;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
#endif
        public static TSMatrix4x4 RotateZ(FP radians, TSVector3 centerPoint)
        {
            TSMatrix4x4 result;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
#endif
        public static void AxisAngle(ref TSVector3 axis, FP angle, out TSMatrix4x4 result)
        {
            // a: angle
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
#endif
        public static TSMatrix4x4 AngleAxis(FP angle, TSVector3 axis)
        {
            TSMatrix4x4 result;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
#endif
        public static void TRS(TSVector3 translation, TSQuaternion rotation, TSVector3 scale, out TSMatrix4x4 matrix)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
#endif
        public static TSMatrix4x4 TRS(TSVector3 translation, TSQuaternion rotation, TSVector3 scale)
        {
            TSMatrix4x4 result;
