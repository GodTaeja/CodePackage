...
namespace TrueSync
{
    ...
    public partial struct FP : IEquatable<FP>, IComparable<FP>
    {
        ...
        public const long PI_TIMES_2 = 0x6487ED511 >> (32 - FRACTIONAL_PLACES);
        public const long PI = 0x3243F6A88 >> (32 - FRACTIONAL_PLACES);
        public const long PI_OVER_2 = 0x1921FB544 >> (32 - FRACTIONAL_PLACES);
        public const long LN2 = 0xB17217F7 >> (32 - FRACTIONAL_PLACES);
        public const long LOG2MAX = 0x1F00000000 >> (32 - FRACTIONAL_PLACES);
        public const long LOG2MIN = -0x2000000000 >> (32 - FRACTIONAL_PLACES);
        //public const int LUT_SIZE = (int)(PI_OVER_2 >> 15);
        public const int LUT_SIZE = (int)(PI_OVER_2 >> (FRACTIONAL_PLACES - 17));

        public const ulong FULL_PART = 0xFFFFFFFFFFFFFFFF;
        public const long FRACTIONAL_PART = 0x00000000FFFFFFFF >> (32 - FRACTIONAL_PLACES);
        public const ulong INTEGER_PART = FULL_PART - FRACTIONAL_PART;
        ...
        public static readonly FP NearOne = new FP(ONE-1L);
...
//for optimize
        public static readonly FP Epsilon = FP.EN6;//FP.EN1;
        ...
        public static FP Floor(FP value)
        {
            ...
            FP result;
            result._serializedValue = (long)((ulong)value._serializedValue & INTEGER_PART);
            return result;
        ...
        {
            var hasFractionalPart = (value._serializedValue & FRACTIONAL_PART) != 0;
        ...
        public static FP Round(FP value)
        {
            ...
            var fractionalPart = value._serializedValue & FRACTIONAL_PART;
            var integralPart = Floor(value);
            long round = ONE / 2;
            if (fractionalPart < round/*0x80000000*/)
            {
                return integralPart;
            }
            if (fractionalPart > round/*0x80000000*/)
        ...
        {
            FP result;
            result._serializedValue = (((long)x) << FRACTIONAL_PLACES) + y._serializedValue;
            return result;
        }
        ...
        {
            FP result;
            result._serializedValue =  x._serializedValue + (((long)y) << FRACTIONAL_PLACES);
            return result;
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
#endif
        public static FP operator +(long x, FP y)
        {
            FP result;
            result._serializedValue = (x << FRACTIONAL_PLACES) + y._serializedValue;
            return result;
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
#endif
        public static FP operator +(FP x, long y)
        {
            FP result;
            result._serializedValue = x._serializedValue + (y << FRACTIONAL_PLACES);
            return result;
        }
        ...
        public static FP operator *(FP x, FP y)
        {
            ...
            var xlo = (ulong)(xl & FRACTIONAL_PART);
            var xhi = xl >> FRACTIONAL_PLACES;
            var ylo = (ulong)(yl & FRACTIONAL_PART);
        ...
        {
            FP result;
            result._serializedValue = x * y._serializedValue;
            return result;
        }
        ...
        {
            FP result;
            result._serializedValue = x._serializedValue * y;
            return result;
        }
        ...
        public static FP operator /(FP x, FP y)
        {
            ...
            FP r;
            r._serializedValue = ((xl / (yl >> 16)) << 16);
            return r;
            */
        ...
        public static FP operator %(FP x, int y)
        {
            long yl = (long)y << FRACTIONAL_PLACES;

            FP result;
            result._serializedValue = x._serializedValue == MIN_VALUE & yl == -1 ?
                0 :
                x._serializedValue % yl;
            return result;
        }
        ...
        public static FP operator %(int x, FP y)
        {
            long xl = (long)x << FRACTIONAL_PLACES;

            FP result;
            result._serializedValue = xl == MIN_VALUE & y._serializedValue == -1 ?
                0 :
                xl % y._serializedValue;
            return result;
        }
        ...
        public static FP Sin(FP x)
        {
            ...
            var nearestValue = new FP(Lut.SinLut[flipHorizontal ?
                Lut.SinLut.Length - 1 - (int)roundedIndex :
                (int)roundedIndex]);
            var secondNearestValue = new FP(Lut.SinLut[flipHorizontal ?
                Lut.SinLut.Length - 1 - (int)roundedIndex - Sign(indexError) :
        ...
        public static FP FastSin(FP x)
        {
            ...
            var nearestValue = Lut.SinLut[flipHorizontal ?
                Lut.SinLut.Length - 1 - (int)rawIndex :
                (int)rawIndex];
        ...
        public static FP Tan(FP x)
        {
            ...
            var nearestValue = new FP(Lut.TanLut[(int)roundedIndex]);
            var secondNearestValue = new FP(Lut.TanLut[(int)roundedIndex + Sign(indexError)]);
        ...
        {
            FP result;
            result._serializedValue = value << FRACTIONAL_PLACES;
            return result;
        }
        ...
        {
            return (float)(((double)value._serializedValue) / ONE);
        }
        ...
        {
            FP result;
            result._serializedValue = ((long)value) << FRACTIONAL_PLACES;
            return result;
        }
        ...
        {
            return (byte)(value._serializedValue >> FRACTIONAL_PLACES);
        }
