...
namespace TrueSync
{
    ...
    public struct TSQuaternion
    {
        ...
        {
            FP result =  a.w * b.w + a.x * b.x + a.y * b.y + a.z * b.z;

            if(result > FP.One)
            {
                result = FP.One;
            }
            else if(result < -FP.One)
            {
                result = -FP.One;
            }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
#endif
        public static TSQuaternion Multiply(TSQuaternion quaternion1, int scaleFactor)
        {
            TSQuaternion result;
            TSQuaternion.Multiply(ref quaternion1, scaleFactor, out result);
            return result;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
#endif
        public static void Multiply(ref TSQuaternion quaternion1, int scaleFactor, out TSQuaternion result)
        {
            result.x = quaternion1.x * scaleFactor;
            result.y = quaternion1.y * scaleFactor;
            result.z = quaternion1.z * scaleFactor;
        ...
        /**
         *  @brief Rotates a {@link TSVector3} by the {@link TSQuanternion}.
         **/
#if INLINE_ENABLE
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
#endif
        ...
        {
            return string.Format("({0:f6}, {1:f6}, {2:f6}, {3:f6})", x.AsFloat(), y.AsFloat(), z.AsFloat(), w.AsFloat());
        }

        public string ToRawString()
        {
            return string.Format("({0}, {1}, {2}, {3})", x.RawValue, y.RawValue, z.RawValue, w.RawValue);
        }
