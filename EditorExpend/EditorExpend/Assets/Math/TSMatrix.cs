...
namespace TrueSync
{
    ...
    public struct TSMatrix
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
#endif
        public static TSMatrix Multiply(TSMatrix matrix1, int scaleFactor)
        {
            TSMatrix result;
            TSMatrix.Multiply(ref matrix1, scaleFactor, out result);
            return result;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
#endif
        public static void Multiply(ref TSMatrix matrix1, int scaleFactor, out TSMatrix result)
        {
            FP num = scaleFactor;
            result.M11 = matrix1.M11 * num;
            result.M12 = matrix1.M12 * num;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
#endif
        public static void Multiply(ref TSMatrix matrix1, long scaleFactor, out TSMatrix result)
        {
            FP num = scaleFactor;
            result.M11 = matrix1.M11 * num;
            result.M12 = matrix1.M12 * num;
